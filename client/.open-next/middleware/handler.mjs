...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function bt(a10) {
        if (!a10.cookies.get("token")?.value) {
          let b2 = new URL("/", a10.url);
          return b2.searchParams.set("redirect", a10.nextUrl.pathname), S.redirect(b2);
        }
        return S.next();
      }

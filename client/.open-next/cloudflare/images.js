...
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "http", hostname: "^(?:^(?:localhost)$)$", port: "5000", pathname: "^(?:\\/uploads(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?)|$))$" }, { protocol: "https", hostname: "^(?:^(?:res\\.cloudinary\\.com)$)$", pathname: "^(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?))$" }];

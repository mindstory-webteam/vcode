...
// NOTE: program.code is sent back untouched — the server owns it. When it's blank
// (a brand-new grade card) the server generates one; when it already has a value
// the server keeps it. Nothing here should ever invent or edit that code.
...
export default function StudentReport() {
  ...
  const submitGradeCard = async (e) => {
    ...
    try {
      const { data } = await updateGradeCard(studentId, serializeGradeCard(gradeCardForm));
